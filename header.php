...
<head>
    ...
    <!--custum css-->
    <link href="http://documents.elatis.cn/css/live2d.css" rel="stylesheet" type="text/css" />
    <link href="<?php $this->options->themeUrl('css/costum.css') ?>" rel="stylesheet" type="text/css" />
    <!--favicon-->
    <link rel="shortcut icon" href="http://documents.elatis.cn/favicon.ico" type="image/x-icon"/> 
	<style>
	    .page-container{
